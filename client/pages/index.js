      ...
      <div className="py-40">
        <div className="container mx-auto px-6 text-gray-600 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-8 lg:items-center lg:gap-24">
            <div className="md:5/12 lg:w-3/5 py-10">
              <img
                src="img/hero-4.svg"
                alt="image"
                loading="lazy"
            ...
            <div className="md:7/12 lg:w-6/12">
              <h2 className="text-2xl text-tanzanite-blue font-bold md:text-4xl">
                Come learn with us!
              </h2>
              ...
              Pachyderm's e-learning platform empowers you to learn new skills and accomplish real growth, whether you're a student or an instructor.
